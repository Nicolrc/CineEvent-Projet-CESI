...
class Article implements JsonSerializable{
    ...
    public static function SqlAdd(Article $article) : int{
       try{
            ...
            INTO articles(Titre,Description,DatePublication,
            Auteur,ImageRepository,ImageFileName) VALUES
           (:Titre, :Description, :DatePublication, :Auteur, 
    ...
    public static function SqlTruncate(): void
    {
        try {
            $bdd = BDD::getInstance();
            $req = $bdd->prepare('TRUNCATE TABLE articles');
            $req->execute();
        }catch (\Exception $e){
            var_dump($e->getMessage());
        }
    ...
    public static function SqlGetLatest(int $nb)
    {
        $bdd = BDD::getInstance();
    ...
    public function jsonSerialize(): mixed
    {
        return [
            ...
            'date_publication' => $this->getDatePublication()->format('Y-m-d'),
