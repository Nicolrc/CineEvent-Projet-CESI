document.addEventListener("DOMContentLoaded", function() {
    ...
    const latEvent = document.getElementById('lat-input');
    const longEvent = document.getElementById('lng-input');
    //Initialisation des la localisation sur Deauville par exemple
    const defautLat = parseFloat(latEvent.value);
    const defautLong = parseFloat(longEvent.value);
    ...
    const initialNom = inputNom.value || "Nouvel événement";
    marker.bindPopup(initialNom).openPopup();
